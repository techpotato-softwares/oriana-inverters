...
RUN npm ci --workspace=@oriana/cms --include-workspace-root --omit=optional || npm install --workspace=@oriana/cms --include-workspace-root
...
RUN npm run build:next -w @oriana/cms
