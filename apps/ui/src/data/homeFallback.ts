...
export const HOME_VISION_MISSION = [
  {
    id: 'vision',
    label: 'Our Vision',
...
export const HOME_GREEN_MISSION = {
...
export const HOME_FOLLOW_ORIANA = {
  title: 'Follow Oriana',
  links: [
    {
