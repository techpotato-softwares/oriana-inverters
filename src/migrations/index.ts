...
import * as migration_20260728_cms_catalogue_fields from './20260728_cms_catalogue_fields'
...
export const migrations = [
  ...
  {
    up: migration_20260728_cms_catalogue_fields.up,
    down: migration_20260728_cms_catalogue_fields.down,
    name: '20260728_cms_catalogue_fields',
  },
]
